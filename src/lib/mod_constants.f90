...
integer, parameter :: d2h  = 24     !! day    -> hour
real(kind=real64),parameter :: h2d  = one/d2h         !! hour   -> day
integer,parameter :: d2m  = d2h*60          !! day    -> minute
...
integer,parameter :: d2s  = 86400  !! day    -> second
integer,parameter :: h2s  = 3600  !! hour   -> second
real(kind=real64),parameter :: s2h  = one/h2s         !! second -> hour
integer,parameter :: m2s  = 60     !! minute -> second
